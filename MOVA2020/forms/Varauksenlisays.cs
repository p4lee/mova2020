...
namespace MOVA2020.forms
{
    public partial class Varauksenlisays : Form
    {
        ...
        private void btvaraus_Click(object sender, EventArgs e)
        {
            ...
            query = "INSERT INTO varaus(varaus_id, mokki_id, palvelu, varattu_pvm, vahvistus_pvm, varattu_alkupvm, varattu_loppupvm) VALUES($varaus_id, $mokki_id, $palvelu, $varattu_pvm, $vahvistus_pvm, $varaus_alkupvm, $varaus_loppupvm)";
